...
import { MatPaginator, MatSort, MatDialog, MatAutocompleteSelectedEvent, MatInput, MatTable } from '@angular/material';
...
export class ListComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { columnDef: 'activite', headName: 'الأنشطة المنجزة' },
    { columnDef: 'annee', headName: ' السنة' },
    { columnDef: 'situation', headName: '(وضعية) حصيلة التنفيد' },
    { columnDef: 'taux', headName: 'معدل الإنجاز' },
    { columnDef: 'effet', headName: '(التأثير) وضعية' },
  ...
  constructor(private uow: UowService, private mydialog: DeleteService
    ...
    , public router: Router, private excel: ExcelService) { }
  ...
  searchAndGet(o: Model) {
    ...
    this.uow.realisations.GetRapportLiterary(this.o).subscribe(
      (r: any) => {
        console.log(r.list);
