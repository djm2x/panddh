...
export class SuperService<T> implements ISuperService {
  ...
  delete = (id: number | string) => this.http.delete<any>(`${this.urlApi}/${this.controller}/delete/${id}`);
  ...
  getOneWithInclude(id) {
    return this.http.get<T>(`${this.urlApi}/${this.controller}/getOneWithInclude/${id}`);
  }
